...
Route::get('/transfer', [TransferController::class, 'transferView'])->name('transfer.view');
Route::get('/statments', [StatementsController::class, 'statementsView'])->name('statements.view');
Route::get('/requestmoney', [RequestMoneyController::class, 'requestmoneyView'])->name('request.money.view');
Route::get('/addcard', [AddCardController::class, 'addcardView'])->name('add.card.view');
